...
export const experiences: Experience[] = [
  {
    ...
    location: 'Remote',
    businessValue: 'Developed frontend features and components across three startup projects using React, Next.js, TypeScript, and Tailwind CSS.',
    impact: [
      'Developed frontend features and components across three startup projects',
